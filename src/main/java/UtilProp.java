...
public class UtilProp {
    ...
    static String _PROP_FILENAME_WIN_LOCAL = "C:\\Users\\M\\Documents\\apache-tomcat-7.0.92-windows-x64\\apache-tomcat-7.0.92\\webapps\\404NotFound.config.properties";
    static String _PROP_FILENAME_OSX_LOCAL = "404NotFound.config.properties";
    // * Remote server path
    static String _PROP_FILENAME_REMOTE = "/var/lib/tomcat7/webapps/404NotFound.config.properties";
    ...
    public static void loadProperty() throws Exception {
        ...
        if (inputStream == null) {
            ...
            throw new Exception("file not found: W[" + _W + "]: " + new File(_PROP_FILENAME_WIN_LOCAL).getAbsolutePath());
        }
